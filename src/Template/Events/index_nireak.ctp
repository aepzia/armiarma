...
<div class="container">
  ...
  <div class="dropdown">
    <a class="btn-top" align="right" href="<?php echo $this->Url->build(array('action'=>'index')) ?>" class="btn btn-primary btn-success pull-right"> <span class="glyphicon glyphicon-folder-open"></span> &nbsp Ekintza guztiak</a>
  </div>
  <div class="list">
    <?php
    $hilabeteak = array(
