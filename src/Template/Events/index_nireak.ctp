...
<div class="container">
  ...
  <div  align="right" lass="dropdown">
    <a class="btn-top" href="<?php echo $this->Url->build(array('action'=>'index')) ?>" class="btn btn-primary btn-success pull-right"> <span class="glyphicon glyphicon-folder-open"></span> &nbsp Ekintza guztiak</a>
  </div>
  <div class="list">
    <?php
    $hilabeteak = array(
            ...
            echo $this->Html->link(
             ...
             echo $this->Form->postLink(
                ...
                array(
                    ...
                    'confirm' => __('Ziur zaude ekitaldia ezabatu nahi duzula?', $event->name)
                )
            );
          endif;?>
